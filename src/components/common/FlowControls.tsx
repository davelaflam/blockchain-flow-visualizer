...
import { Button, useMediaQuery, useTheme, styled, Box } from '@mui/material';
...
/**
 * ControlsContainer is a styled component that serves as the container for the flow controls.
 */
...
/**
 * buttonStyles defines the base styles for all buttons in the flow controls.
 */
const buttonStyles = {
  borderRadius: '4px',
...
/**
 * PlayButton is a styled button component that serves as the main control for playing and pausing the flow.
 */
...
/**
 * NavButton is a styled button component for navigation controls like previous, next, and reset.
 */
...
const FlowControls: React.FC<FlowControlsProps> = ({
  ...
  /**
   * Effect to handle keyboard shortcuts for flow controls.
   */
  useEffect(() => {
